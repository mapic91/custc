...
#define SCE_JXQY_DEFAULT 0
#define SCE_JXQY_COMMENT 1
#define SCE_JXQY_KEYWORD 2
#define SCE_JXQY_GOTOPOS 3 //@xxx
#define SCE_JXQY_FUNCTION 4 // xxx(,,....)
#define SCE_JXQY_STRING 5
#define SCE_JXQY_OPERATOR 6
#define SCE_JXQY_VARIABLE 7
#define SCE_JXQY_IDENTIFIER 8
#define SCE_JXQY_NUMBER 9
