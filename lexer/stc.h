...
// Lexical states for JXQY
#define wxSTC_JXQY_DEFAULT 0
#define wxSTC_JXQY_COMMENT 1
#define wxSTC_JXQY_KEYWORD 2
#define wxSTC_JXQY_GOTOPOS 3 //@xxx
#define wxSTC_JXQY_FUNCTION 4 // xxx(,,....)
#define wxSTC_JXQY_STRING 5
#define wxSTC_JXQY_OPERATOR 6
#define wxSTC_JXQY_VARIABLE 7
#define wxSTC_JXQY_INDETIFIER 8
#define wxSTC_JXQY_NUMBER 9
